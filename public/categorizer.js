...
function categorizeArticle(title, summary) {
  ...
  const assignedCategory = topCategory[1] > 0 ? topCategory[0] : "general";
...
// Export for ES modules and standard script inclusion support
if (typeof module !== "undefined" && module.exports) {
  module.exports = { TAXONOMY, categorizeArticle };
}
